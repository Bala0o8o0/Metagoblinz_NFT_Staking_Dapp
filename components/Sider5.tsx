...
const NFTSlider5 = () => {
  ...
  const images = [
    ...
    { src: "/alien-46.png", alt: "NFT 7" },
    { src: "/alien-7.png", alt: "NFT 1" },
    { src: "/alien-46.png", alt: "NFT 13" },
    { src: "/alien-23.png", alt: "NFT 12" },
    { src: "/alien-29.png", alt: "NFT 5" },
    { src: "/alien-13.png", alt: "NFT 13" },
    { src: "/alien-52.png", alt: "NFT 2" },
    { src: "/alien-28.png", alt: "NFT 3" },
    { src: "/alien-47.png", alt: "NFT 4" },
    { src: "/alien-7.png", alt: "NFT 10" },
    { src: "/alien-49.png", alt: "NFT 5" },
    { src: "/alien-50.png", alt: "NFT 6" },
    { src: "/alien-29.png", alt: "NFT 8" },
    { src: "/alien-46.png", alt: "NFT 9" },
    { src: "/alien-1.png", alt: "NFT 11" },
  ];
